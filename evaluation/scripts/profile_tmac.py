...
def parse_args():
    ...
    parser.add_argument("-k", "--kernel", type=str, choices=["qgemm_lut", "preprocessor"], default="all")
        ...
        for dtype in dtypes:
            for bits in bitss:
                for num_threads in threads:
                    ...
                    df['total'] = df['qgemm_lut'] + df['preprocessor']
