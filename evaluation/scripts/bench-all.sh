...
# Benchmark I2_S, I2_T
./bench-pp.sh -m ~/Projects/llama.cpp-bitnet/models/BitNet/3B-I2S.gguf -p 128,256,512 -t 1,2,4,8,16 -r 3 --csv
...
./bench-pp.sh -w ~/Projects/llama.cpp -m ~/Projects/llama.cpp/models/BitNet/3B-Q2K.gguf -p 128,256,512 -t 1,2,4,8,16 -r 3 --csv
...
# Benchmark T-MAC
./bench-pp.sh -w ~/Projects/T-MAC/3rdparty/llama.cpp -m ~/Projects/T-MAC/3rdparty/llama.cpp/models/BitNet/3B.gguf -p 128,256,512 -t 1,2,4,8,16 -r 3 --csv
# mv results back and merge with current
