...
static const ggml_type bitnet_types[] = {
    GGML_TYPE_Q4_0,
    // GGML_TYPE_IQ4_NL,
    GGML_TYPE_I2_S,
};

static const ggml_type bitnet_256_types[] = {
    // GGML_TYPE_Q2_K,
    // GGML_TYPE_IQ2_S,
    // GGML_TYPE_Q4_0,
    // GGML_TYPE_IQ4_NL,
...
static std::vector<std::unique_ptr<test_case>> make_test_cases_eval() {
    ...
    for (int i = 0; i < 1000; i++) {
        for (ggml_type type_a : bitnet_types) {
...
static std::vector<std::unique_ptr<test_case>> make_test_cases_perf() {
    std::vector<std::unique_ptr<test_case>> test_cases;
    std::vector<int> test_ns = {128, 512, 1024};
    ...
    for (int n : test_ns) {
        ...
        for (ggml_type type_a : bitnet_types) {
            for (ggml_type type_b : {GGML_TYPE_F32}) {
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 3200, n, 3200, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 3200, n, 8640, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 8640, n, 3200, {1, 1}, {1, 1}));
            }
        }
        
        // llama3 8b
        for (ggml_type type_a : bitnet_256_types) {
            for (ggml_type type_b : {GGML_TYPE_F32}) {
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 4096, n, 4096, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 4096, n, 14336, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 14336, n, 4096, {1, 1}, {1, 1}));
            }
        }
        ...
        for (ggml_type type_a : bitnet_256_types) {
            for (ggml_type type_b : {GGML_TYPE_F32}) {
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 2048, n, 2048, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 2048, n, 8192, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 8192, n, 2048, {1, 1}, {1, 1}));
            }
        }
        ...
        for (ggml_type type_a : bitnet_256_types) {
            for (ggml_type type_b : {GGML_TYPE_F32}) {
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 2048, n, 2048, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 2048, n, 6144, {1, 1}, {1, 1}));
                test_cases.emplace_back(new test_mul_mat(type_a, type_b, 6144, n, 2048, {1, 1}, {1, 1}));
            }
        }
    }
